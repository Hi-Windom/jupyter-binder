...
def find_milestone(repo, title):
    ...
    print('''
---
❤️ 快速反馈 694357845@qq.com
💠 海文东QQ频道：43in2c1qb9
🚢 [Docker Image Available](https://hub.docker.com/r/soltus/jupyter-binder)
<span>
<img src="https://img.shields.io/badge/Windows 10+-black?logo=Windows 11" title=""/><img src="https://img.shields.io/badge/Docker-black?logo=docker" title=""/>
</span>
--
...
def generate_msg(desc_mapping):
    ...
    print()
    print('## [@jupyter-binder](https://github.com/Hi-Windom/jupyter-binder)\n')
